# BefundTool MVP v0.7.2

A production-quality MVP web application for radiology reporting with server-side speech recognition and LLM-powered report generation, built with Next.js and TypeScript.

## What's New in v0.7.2

- **Vercel Deployment Ready**: Streamlined deployment with Vercel environment variables
- **Collapsible Dictionary**: Radiologie-Wörterbuch now uses accordion UI like other sections
- **Version Endpoint**: `/api/version` returns app version and deployment commit
- **No Study Dropdown**: Simplified UI using template name as UNTERSUCHUNG
- **Auto-Template Selection**: Automatically selects best template with manual override
- **LLM Status Indicator**: Shows "LLM aktiv" or "Fallback" mode in UI
- **Auto-Report Creation**: Reports auto-created on first interaction
